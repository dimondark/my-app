...
class FormContainer extends React.Component {
  ...
  CardItem(card, idx) {
    const cardNameSelection = [
      ...
      'Card_Movement_Go',
      'Card_Movement_Stay',
      'Card_Movement_GoBack',
      'Card_Movement_GoLeft',
      'Card_Movement_GoRight',
      'Card_Movement_GoUp',
      'Card_Movement_GoDown',
      'Card_Movement_ForrestRoad',
      'Card_Movement_PlainRoad',
      'Card_Movement_MountainRoad',
      'Card_Movement_Sail',
      'Card_Movement_Fly',
      'Card_Movement_Run',
      'Card_Movement_Jump',
